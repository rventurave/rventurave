...
* 🎓 Computer Science student at the Universidad Nacional de San Agustín de Arequipa (UNSA).
* 💻 Interested in Software Engineering, Computer Science and Machine Learning.
* 🚀 I enjoy building software to solve real-world problems.
* 🧠 Currently strengthening my knowledge in algorithms, data structures and software architecture.
* 🤖 Working with Machine Learning and data analysis using Python.
* 🎨 Interested in Computer Graphics, OpenGL and 2D/3D applications.
* 🌐 Developing projects with HTML, CSS, JavaScript, APIs and JSON.
* 🌐 Interested in Computer Networks and distributed systems.
* 🖥️ Comfortable working with Linux and Windows environments.
...
Technologies:
C++ Data Structures LRU Buffer Pool CMake
...
Technologies:
HTML5 CSS3 JavaScript JSON REST APIs
